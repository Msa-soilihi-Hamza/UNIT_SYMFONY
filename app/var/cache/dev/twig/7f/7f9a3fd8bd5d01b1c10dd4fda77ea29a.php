...
class __TwigTemplate_05056cf69ba4876fe324595a9021f794 extends Template
{
    ...
    <label for=\"inputHamza\">Hamza</label>
    <input type=\"text\" value=\"";
        ...
        yield "\" name=\"hamza\" id=\"inputHamza\" class=\"form-control\" autocomplete=\"username\" required autofocus>
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputHamza\">Hamza</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"hamza\" id=\"inputHamza\" class=\"form-control\" autocomplete=\"username\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\laragon\\www\\UNIT_SYMFONY\\app\\templates\\security\\login.html.twig");
    }
}
